...
public class VideoLectureModelAdapterTwo extends RecyclerView.Adapter<VideoLectureModelAdapterTwo.ViewHolder> {
    ...
    public VideoLectureModelAdapterTwo(Activity mCtx, List<VideoLectureModel> videoLectureModelList) {
        this.mCtx = mCtx;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_lecture_model_two, parent, false);
